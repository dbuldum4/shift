...
optional or release-managed converter runtimes. The authoritative Rust dependency graph
...
System tools such as FFmpeg, Pandoc, Typst, qpdf, and macOS `sips` are not
relicensed by Shift; when installed or supplied by the user, they remain subject
to their own license terms. The release-managed Python and Node.js runtimes are
also distributed under their upstream licenses. The same is true for optional
