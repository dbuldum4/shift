...
const shortcuts = [
  ...
  ["←→↑↓ or j / k", "Move add actions, queued inputs, or conversion options"],
  ["enter", "Activate the focused add action, setting, or run"],
  ["space", "Toggle overwrite or folder expansion"],
